...
?>
    ...
    <h2> 專案介紹 Introduction </h2>
        ...
        <p>
            在此研究中，<span style="color:blue">我們希望建立一個電腦程式，輸入一個立場(例如: 支持廢除死刑)，以及一篇文章(例如: 一篇支持廢除死刑的論述文)，就能夠智慧地判定本篇文章是否支持這個立場。</span> 而我們預計使用機器學習技術建立此一程式，因此我們需要您的幫忙，建立訓練語料庫，意即許多 [立場, 文章, 支持/反對/中立] 這樣的資料。</p>
    <br>
