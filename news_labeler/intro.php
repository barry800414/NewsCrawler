...
?>
    ...
    <h2> 研究動機 Motivation </h2>
        <p>
            即使現在已經有大量的網路新聞、評論；然而，現今許多媒體經常傳遞立場不中立的文章給閱聽者。因此，我們希望能夠建立一智慧程式，能自動判定文章之立場，如此一來，便能運用此程式將支持不同立場的文章呈現給使用者，以紓解此問題。         </p>
        <p> There has been huge amounts of online newspapers, comments and articles on the Internet in recent decades. However, some of media often deliver biased articles to the audience. As a result, it is crucial to build up an intelligent agent who can help us judge the standpoints of articles. With the assistance of intelligent agent, we can easily give a query to find articles with standpoints.</p>
    <h2> 標記步驟 Steps </h2>
    <p>你將會被給定一篇從網路上擷取的文章，以及一個敘述句(立場)。我們希望您能協助我們標記下面四個問題的答案:</p>
    <ol>
        <li class="text-left">該文章是否有格式上的錯誤(例如: 非內文之廣告)。</li>
    ...
    <p>On this annotation website, you will be give one article crawled from online websites and one statement(i.e. the standpoint). We hope you can help us find that 
        <ol>
            <li class="text-left">whether the article has strange content(e.g. advertisements)</li>
            ...
            <li class="text-left">the overall polarity(agree/disagree/neutral) of the whole article to the give statement.</li>
        </ol>
    </p>
